              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    readOnly={isAmountAndDateLocked}
                    disabled={isAmountAndDateLocked}
                    onChange={(e) => {
                      if (!isAmountAndDateLocked) {
